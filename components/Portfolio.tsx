...
const PROJETOS_DEFAULT = [
  { id: '1', categoria: 'Cozinha',     titulo: 'Cozinha Contemporânea', local: 'Niterói, RJ',    img_url: 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=800&q=75', tall: true  },
  { id: '2', categoria: 'Dormitório',  titulo: 'Suíte Master',           local: 'Rio de Janeiro', img_url: 'https://images.unsplash.com/photo-1616594039964-ae9021a400a0?w=800&q=75', tall: false },
  { id: '3', categoria: 'Sala',        titulo: 'Sala Integrada',          local: 'Niterói, RJ',   img_url: 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=800&q=75', tall: false },
  { id: '4', categoria: 'Home Office', titulo: 'Home Office Executivo',   local: 'São Gonçalo',   img_url: 'https://images.unsplash.com/photo-1593642632559-0c6d3fc62b89?w=800&q=75', tall: true  },
  { id: '5', categoria: 'Cozinha',     titulo: 'Cozinha Americana',       local: 'Niterói, RJ',   img_url: 'https://images.unsplash.com/photo-1556909172-54557c7e4fb7?w=800&q=75', tall: false },
  { id: '6', categoria: 'Dormitório',  titulo: 'Closet Completo',         local: 'Rio de Janeiro', img_url: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800&q=75', tall: false },
]

interface PortfolioItem { id: string; categoria: string; titulo: string; local: string; img_url: string; tall: boolean }
